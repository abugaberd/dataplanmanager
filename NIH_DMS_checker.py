...
def run():
    ...
    st.markdown(
            ...
            **👈 Customize model settings via the sidebar**
            """
        )
    ...
    with st.sidebar:
      ...
      os.environ['REPLICATE_API_TOKEN'] = r8_Nsi3xcgcRrM4NC6TjALQDEsBqmt8Xdg0rGd1C #replicate_api
    ...
    if st.button('Check this DMS plan (click once and wait)'):
      ...
      #st.markdown(combinedprompt, unsafe_allow_html=True)
